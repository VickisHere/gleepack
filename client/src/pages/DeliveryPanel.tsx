        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Delivery Panel</h1>
                <p className="text-gray-600 mt-2">Manage and track your deliveries in real-time</p>
              </div>
                  ...
                  <div className="px-4 sm:px-6 py-4 bg-gray-50">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600 space-y-1">
                            <p className="font-medium">{order.contact?.name || order.userName || 'N/A'}</p>
                            <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="flex items-center">
                                <Phone className="h-4 w-4 text-gray-400 mr-1" />
                                <p>{order.contact?.phone || order.userPhone || 'N/A'}</p>
                              </div>
                            ...
                            {order.contact?.email && (
                              <div className="flex items-center">
                                ...
                                <p className="ml-1">{order.contact.email}</p>
                              </div>
                            )}
                          </div>
                        </div>
                          ...
                          <div className="text-sm text-gray-600 space-y-1">
                            {order.contact ? (
                              <>
                                ...
                                <p>{order.contact.flatNo && `${order.contact.flatNo}, `}{order.contact.area || ''}</p>
                                {order.contact.district && <p>{order.contact.district}</p>}
                                {order.contact.pincode && <p>PIN: {order.contact.pincode}</p>}
                                {order.contact.landmark && <p className="text-orange-600 font-medium">Landmark: {order.contact.landmark}</p>}
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-gray-900">Payment & Total</h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                          ...
                          <div>
                            ...
                            <div className="space-y-1 text-sm text-gray-600">
                              ...
                              {order.contact?.landmark && <p>Landmark: {order.contact.landmark}</p>}
                              ...
                              {order.specialNotes && (
                                <div className="mt-2 p-2 bg-blue-50 rounded border-l-4 border-blue-400">
                                  ...
                                  <p className="text-xs text-blue-700">{order.specialNotes}</p>
                                </div>
                              )}
                            </div>
                          </div>
            ...
            {orders.length === 0 && (
              <div className="bg-white shadow rounded-lg p-12">
                <div className="text-center">
                  ...
                  <p className="mt-1 text-sm text-gray-500">There are no orders ready for delivery.</p>
                </div>
              </div>
            )}
          </div>
