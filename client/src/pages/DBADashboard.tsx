        ...
        if (!editingId) return;
            ...
            if (uploadFile) {
                try {
                    ...
                    const imageUpdateRes = apiFetch ? await apiFetch(`/api/products/${editingId}`, { method: 'PATCH', body: JSON.stringify({ image: url }) }) : await fetch(`/api/products/${editingId}`, { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ image: url }) });
