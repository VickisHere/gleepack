          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => {
                ...
                return (
                  <div key={item.id} className="card-festive p-6">
                    <div className="flex gap-4">
                      <div className="w-20 h-20 bg-gradient-to-br from-primary/20 to-secondary/10 rounded-lg flex items-center justify-center text-4xl">
                        🎉
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground capitalize">{item.tier}</p>
